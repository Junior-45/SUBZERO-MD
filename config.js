...
module.exports = {
    // ===== BOT CORE SETTINGS =====
    SESSION_ID: process.env.SESSION_ID || "SUBZERO-MD~M5RDFIiI#VoZAlLF25GOD3jWYvz8kp-zFtLNhfVkrBvnkbiIzkn0",  // Your bot's session ID (keep it secure)
    PREFIX: process.env.PREFIX || "e",         // Command prefix (e.g., "., / ! * - +")
    BOT_NAME: process.env.BOT_NAME || "Dragon",  // Bot's display name
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "50935623320",  // Owner's WhatsApp number
    OWNER_NAME: process.env.OWNER_NAME || "Mr Frank",           // Owner's name
    DEV: process.env.DEV || "50935623320",                     // Developer's contact number
    ...
    STICKER_NAME: process.env.STICKER_NAME || "Dragon",     // Sticker pack name
